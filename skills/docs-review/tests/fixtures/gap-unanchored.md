...
| Gap | Requirement | What is absent | Anchor | Shape | Neighbour |
| --- | ----------- | -------------- | ------ | ----- | --------- |
| G-001 | REQ-EXP-001 | no version gate on the export path | the estimates table | add a column | — |
| G-002 | REQ-EXP-002 | no retry budget | ../../scripts/nonexistent_file.py:12 | a config key | — |
| G-003 | REQ-EXP-003 | no audit row | ../../scripts/check_report.py:999999 | a new writer | — |
| G-004 | REQ-EXP-004 | no cache | ../../scripts/check_report.py:14 | a decorator, about 2 days of work | — |
